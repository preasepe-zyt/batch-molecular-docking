#!/usr/bin/env /root/autodl-tmp/mgltools_x86_64Linux2_1.5.7/bin/python
#
# 
#
...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print "        [-w]   assign each ligand atom a unique name: newname is original name plus its index(1-based)"
